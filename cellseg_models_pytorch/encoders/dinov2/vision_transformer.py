...
def named_apply(
    ...
    """Apply a function to a module and its named children."""
...
class BlockChunk(nn.ModuleList):
    def forward(self, x):
        """Forward pass of the chunked block."""
        for b in self:
            x = b(x)
        return x
...
class DinoVisionTransformer(nn.Module):
    def __init__(
        ...
        Args:
            ...
            block_chunks: (int) split block sequence into block_chunks units for FSDP wrap # noqa
        """
        super().__init__()
    ...
    def forward_features_list(self, x_list, masks_list):
        """Forward pass of the features list."""
        x = [
...
def init_weights_vit_timm(module: nn.Module, name: str = ""):
    """Apply ViT weight initialization, original timm impl (for reproducibility)."""
